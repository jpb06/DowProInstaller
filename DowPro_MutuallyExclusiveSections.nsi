...
Section "Vanilla Soulstorm Hotkeys" SectionHotkeysVanilla
 ...
 loop:
	...
	File /r ".\Content\Hotkeys_Vanilla\*.*"
...
Section /o "Left-Handed Hotkeys" SectionHotkeysLeftHanded
 ...
 loop:
	...
	StrCmp $1 ".." skip
	SetOutPath "$INSTDIR\Profiles\$1\DoWpro"
	File /r ".\Content\Hotkeys_LeftHanded\*.*"
...
Section "Uninstall"
  ...
  ;TODO : remove hotkeys
  ;TODO : remove dowpro related files in soulstorm root

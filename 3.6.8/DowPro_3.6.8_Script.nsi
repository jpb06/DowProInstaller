...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to the DoWpro 3.68 Full Installer Setup Wizard"
  !define MUI_WELCOMEPAGE_TEXT "This program will install the DoWpro mod for Dawn of War: Soulstorm. Click on Next to continue."
...
Section /o "Manuals" SectionManuals
...
;Descriptions
  ...
  LangString DESC_SectionManuals ${LANG_ENGLISH} "Installs DoWpro manuals."
